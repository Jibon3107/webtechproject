   ...
   <?php
                ...
                if(isset($_POST["submit"]))
                {
                    if($email == "admin@email.com")
                    {
                        ...
                        {
                            $er_password = "Invalid Password";
                        }
                    }
                    else
                    {
                        $er_email = "Invalid E-mail";
                    }
                    
                    
                    if($email == "manager@email.com")
                    {
    ...
    <section>
        ...
        <br><br><br><br><h6 style="text-align: center; color: yellow; letter-spacing: 2px">© 2020 Webtech sec: A</h6><br><br>
    </section>  
</body>
</html>
